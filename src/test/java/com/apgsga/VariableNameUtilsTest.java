...
class VariableNameUtilsTest implements RewriteTest {
    ...
    @Test
    void allClassFieldsAreFoundClass() {
        rewriteRun(
          baseTest("SomePojo", "titel,vorgabenTitel,vorgabenText,vorgabenLink,abwoId,sujet,anlieferadresse,anlieferDatumZwei,anlieferDatumDrei"),
          java(
            """
              class SomePojo {
                private String titel;
                private String vorgabenTitel;
                private String vorgabenText;
                private String vorgabenLink;
                private Long abwoId;
                private String sujet;
                private String anlieferadresse;
                private String anlieferDatumZwei;
                private String anlieferDatumDrei;
              }
              """
          )
        );
